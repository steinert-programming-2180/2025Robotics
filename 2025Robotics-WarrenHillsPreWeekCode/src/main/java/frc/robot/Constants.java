...
public final class Constants {
    ...
    public static class EndgameConstants{
        public static final int endgameSpinMotor1 = 999;  
        public static final int engameRotationMotor = 998; 
    ...
    public static class WristConstants{
        ...
        public static final double armWristP=0.03; 
        public static final double armWristI=0;
        public static final double armWristD=0.6;


        public static final double intakeSpeed = 0.5; // speed for having the wrist motor for intake
        public static final double algaeSpeed = 0.5; // speed for having the algae motor for intake

        public static final int wristRotationPort = 14;
        public static final int intakeMotorPort = 16;
        public static final int algaeMotorPort = 15;

        public static double writsRotationOffset=117;
    }
    ...
    public static class ArmConstants{
        ...
        public static final double armZeroPos=armAngleOffset;

        public static final int bottomLimitSwitchID=0;
        public static final int topLimitSwitchID=999;

        public static final double armExtensionRadius=(1+3/8)/2; //in inches (update this)
    }
